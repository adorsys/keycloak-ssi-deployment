...
## I- deploy and configur a Keycloak server with OID4VCI capabilities. sets up necessary components for issuing verifiable credentials, specifically `SteuerberaterCredential` and `IdentityCredential`.
### 1-Create new realm
